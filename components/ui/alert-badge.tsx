...
export type IconType = React.ComponentType<React.ComponentProps<"svg">> | React.ComponentType<any>

const alertBadgeVariants = cva(
  "inline-flex items-center gap-2.5 rounded-sm px-2.5 py-1.5 text-xs font-semibold text-white",
  {
    variants: {
      variant: {
        error: "bg-red-500",
